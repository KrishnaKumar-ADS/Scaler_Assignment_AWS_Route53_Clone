    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-lg text-white">Zone Records</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="flex justify-between items-end">
          <div>
            <h2 className="text-2xl font-bold text-white tracking-tight">DNS Records Management</h2>
            <p className="text-zinc-400 mt-1">Create and manage routing configurations for this zone.</p>
          </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md bg-zinc-950 border-zinc-800 text-zinc-200">
              <DialogHeader>
                <DialogTitle className="text-white">Create DNS Record</DialogTitle>
              ...
              <form onSubmit={handleCreateRecord} className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="flex h-10 w-full items-center justify-between rounded-md border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
          ...
          <Table>
            <TableHeader className="bg-zinc-900/80">
              <TableRow className="border-zinc-800 hover:bg-transparent">
                <TableHead className="text-zinc-400">Record Name</TableHead>
                <TableHead className="text-zinc-400">Type</TableHead>
                <TableHead className="text-zinc-400">Value / Target</TableHead>
                <TableHead className="text-zinc-400">TTL</TableHead>
            ...
            <TableBody>
              {loading ? (
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-8 text-zinc-500">Loading records...</TableCell>
                </TableRow>
              ) : records.length === 0 ? (
                <TableRow>
                ...
                records.map((record) => (
                  <TableRow key={record.id} className="border-zinc-800 hover:bg-zinc-800/50 transition-colors group">
                    ...
                    <TableCell className="text-zinc-400">{record.ttl}s</TableCell>
